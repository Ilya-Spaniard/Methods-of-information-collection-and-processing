...
## task7
1. Взять любую категорию товаров на сайте Леруа Мерлен (если будет блокировать с 401 ошибкой, возьмите сайт https://www.castorama.ru/). Собрать следующие данные:
* название;
* все фото;
* ссылка;
* цена.
...
P.S. т.к. https://novosibirsk.lemanapro.ru/ выдавал ошибку 401, а https://www.castorama.ru/ не доступен, был взят сайт https://www.citilink.ru/
